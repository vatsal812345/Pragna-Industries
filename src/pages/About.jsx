          ...
          <div className="flex flex-col lg:flex-row items-center gap-10 sm:gap-12 lg:gap-16">
            <div className="lg:w-1/2">
              ...
              > <div className="flex items-center space-x-2 text-pragna-maroon font-bold uppercase tracking-wider mb-4">
                ...
                <h2 className="text-2xl sm:text-3xl lg:text-4xl font-bold text-gray-900 mb-4 sm:mb-6">Leading Experts in Fabrication & Manufacturing</h2>
            ...
            <div className="lg:w-1/2 grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-6">
              <div className="space-y-4 sm:space-y-6">
                <img src="/1.jpg" alt="Industrial Fabrication" className="rounded-2xl shadow-xl w-full h-48 sm:h-80 object-cover" />
                <div className="bg-pragna-maroon p-6 sm:p-8 rounded-2xl text-white shadow-xl">
                  <h4 className="text-2xl sm:text-3xl font-black mb-2">50+</h4>
                  <p className="opacity-80 font-medium">Years of Experience</p>
                </div>
              </div>
              <div className="space-y-4 sm:space-y-6 sm:pt-12">
                <div className="bg-gray-100 p-6 sm:p-8 rounded-2xl shadow-inner border border-gray-200">
                  <h4 className="text-2xl sm:text-3xl font-black text-gray-900 mb-2">25k+</h4>
                  <p className="text-gray-600 font-medium">Products Delivered</p>
                </div>
                <img src="/2.jpg" alt="Metal Work" className="rounded-2xl shadow-xl w-full h-48 sm:h-80 object-cover" />
              </div>
            </div>
          </div>
        </div>
              ...
              >
                <div className="mb-8 relative inline-block">
                  ...
                  <div className="overflow-hidden rounded-[2rem] shadow-2xl">
                    <img src={leader.image} alt={leader.name} className="w-48 h-64 sm:w-72 sm:h-96 object-cover" />
                  </div>
                </div>
                <div className="text-center">
                  <h3 className="text-2xl sm:text-3xl font-black text-gray-900 mb-2">{leader.name}</h3>
      ...
      <section className="py-14 sm:py-20 lg:py-24 bg-white relative overflow-hidden">
        <div className="container mx-auto px-4 relative z-10">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              <div className="p-6 sm:p-8 lg:p-10 text-center bg-gray-50/50 rounded-3xl border border-gray-100 hover:shadow-2xl hover:border-pragna-maroon/20 transition-all duration-500 group">
              <div className="w-20 h-20 bg-white text-pragna-maroon flex items-center justify-center rounded-2xl shadow-lg mx-auto mb-8 group-hover:scale-110 group-hover:bg-pragna-maroon group-hover:text-white transition-all duration-500">
                ...
                <h3 className="text-xl sm:text-2xl font-black mb-3 sm:mb-4 text-gray-900 uppercase tracking-tighter">Quality Driven</h3>
                <p className="text-gray-600 leading-relaxed text-base sm:text-lg">We adhere to the highest standards of manufacturing precision and material quality.</p>
            </div>
              <div className="p-6 sm:p-8 lg:p-10 text-center bg-gray-50/50 rounded-3xl border border-gray-100 hover:shadow-2xl hover:border-pragna-maroon/20 transition-all duration-500 group">
              <div className="w-20 h-20 bg-white text-pragna-maroon flex items-center justify-center rounded-2xl shadow-lg mx-auto mb-8 group-hover:scale-110 group-hover:bg-pragna-maroon group-hover:text-white transition-all duration-500">
                <Users size={40} />
              </div>
                <h3 className="text-xl sm:text-2xl font-black mb-3 sm:mb-4 text-gray-900 uppercase tracking-tighter">Client Focused</h3>
                <p className="text-gray-600 leading-relaxed text-base sm:text-lg">Every project starts with understanding your specific needs and design requirements.</p>
            </div>
              <div className="p-6 sm:p-8 lg:p-10 text-center bg-gray-50/50 rounded-3xl border border-gray-100 hover:shadow-2xl hover:border-pragna-maroon/20 transition-all duration-500 group">
              <div className="w-20 h-20 bg-white text-pragna-maroon flex items-center justify-center rounded-2xl shadow-lg mx-auto mb-8 group-hover:scale-110 group-hover:bg-pragna-maroon group-hover:text-white transition-all duration-500">
                <TrendingUp size={40} />
              </div>
                <h3 className="text-xl sm:text-2xl font-black mb-3 sm:mb-4 text-gray-900 uppercase tracking-tighter">Constant Growth</h3>
                <p className="text-gray-600 leading-relaxed text-base sm:text-lg">Implementing new technologies and methods to stay ahead in the fabrication industry.</p>
            </div>
          </div>
        </div>
      </section>
